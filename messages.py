...
# 模型/资源列表提示语
MSG_INVALID_RESOURCE_TYPE = "无效的资源类型"
MSG_GET_RESOURCE_FAIL = "获取 {resource_type} 资源失败: {error}"
...
# 新增：当前模型显示相关消息
MSG_CURRENT_MODEL_SUCCESS = "📦 当前使用模型:\n「{current_model}」"
MSG_UNKNOWN_MODEL = "未知模型"

# /sd conf display messages
MSG_GEN_PARAMS = "文生图参数"
MSG_GLOBAL_POSITIVE_PROMPT = "全局正向提示词"
MSG_GLOBAL_NEGATIVE_PROMPT = "全局负面提示词"
MSG_BASE_MODEL = "基础模型"
MSG_IMAGE_DIMENSIONS = "分辨率"
MSG_STEPS = "步数"
MSG_SAMPLER = "采样器"
MSG_SCHEDULER = "调度器"
MSG_CFG_SCALE = "CFG比例"
MSG_BATCH_SIZE = "每批数量"
MSG_N_ITER = "迭代次数"
MSG_UPSCALE_PARAMS = "图像增强参数"
MSG_UPSCALE_FACTOR = "放大倍数"
MSG_UPSCALER_ALGORITHM = "上采样算法"
MSG_PROMPT_GUIDELINES = "LLM提示词限制"
MSG_VERBOSE_MODE = "详细输出模式"
MSG_UPSCALE_MODE = "图像增强模式"
MSG_SHOW_PROMPT_MODE = "显示正向提示词"
MSG_LLM_PROMPT_MODE = "LLM生成提示词"
MSG_DENOISING_STRENGTH = "重绘幅度"
